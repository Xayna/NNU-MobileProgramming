...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_linear) {
            startActivity(LinearActivity.class);
        }

        if (id ==R.id.action_relative){
            startActivity(RelativeActivity.class);
        }
...
private void startActivity(Class<?> activitClass) {

    Intent i = new Intent(MainActivity.this , activitClass);
    startActivity(i);
    }
}
